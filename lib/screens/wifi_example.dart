...
//     } on Exception {
//       iWiFiState = WIFI_AP_STATE.WIFI_AP_STATE_FAILED.;
//     }

//     if (iWiFiState == WIFI_AP_STATE.WIFI_AP_STATE_DISABLING) {
//       wifiAPState = WIFI_AP_STATE.WIFI_AP_STATE_DISABLING;
//     } else if (iWiFiState == WIFI_AP_STATE.WIFI_AP_STATE_DISABLED) {
//       wifiAPState = WIFI_AP_STATE.WIFI_AP_STATE_DISABLED;
//     } else if (iWiFiState == WIFI_AP_STATE.WIFI_AP_STATE_ENABLING) {
//       wifiAPState = WIFI_AP_STATE.WIFI_AP_STATE_ENABLING;
//     } else if (iWiFiState == WIFI_AP_STATE.WIFI_AP_STATE_ENABLED) {
//       wifiAPState = WIFI_AP_STATE.WIFI_AP_STATE_ENABLED;
//     } else if (iWiFiState == WIFI_AP_STATE.WIFI_AP_STATE_FAILED) {
