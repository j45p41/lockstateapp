...
//
//     final getDeviceHistoryResponse = getDeviceHistoryResponseFromJson(jsonString);

import 'dart:convert';

List<GetDeviceHistoryResponse> getDeviceHistoryResponseFromJson(String str) =>
    List<GetDeviceHistoryResponse>.from(
        json.decode(str).map((x) => GetDeviceHistoryResponse.fromJson(x)));

String getDeviceHistoryResponseToJson(List<GetDeviceHistoryResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetDeviceHistoryResponse {
  ...
  factory GetDeviceHistoryResponse.fromJson(Map<String, dynamic> json) =>
      GetDeviceHistoryResponse(
...
class UplinkMessage {
  ...
  factory UplinkMessage.fromJson(Map<String, dynamic> json) => UplinkMessage(
        ...
        networkIds: NetworkIds.fromJson(json["network_ids"]),
      );
...
class NetworkIds {
  ...
  factory NetworkIds.fromJson(Map<String, dynamic> json) => NetworkIds(
        netId: json["net_id"],
