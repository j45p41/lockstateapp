...
EMAIL="new2@maintest.com"             # ← your Firebase email
PASS="test123"                        # ← your password

echo
echo "1) GET  /alexaAuth?uid=… → fetch 'state'"
STATE=$(
...
echo
echo "2) GET  /alexaCallback?code=poke&state=… → fetch AUTH_CODE"
AUTH_CODE=$(
  curl -s -D - -o /dev/null -G \
...
echo
echo "✅ If you see HTTP/2 200 and JSON with your FB_UID as access_token, you’re good."
